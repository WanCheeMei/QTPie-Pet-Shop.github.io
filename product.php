...
<html>
<head>
	<title>QTPie Pet Shop Product Page</title>
...
<body>
    ...
    <ul>
        ...
        <li><a href="#" onclick="showCategory('dogfood')">Dog Food</a></li>
        <li><a href="#" onclick="showCategory('dogtreats')">Dog Treats</a></li>
        <li><a href="#" onclick="showCategory('dogtoys')">Dog Toys</a></li>
        <li><a href="#" onclick="showCategory('dogclothes')">Dog Clothes</a></li>
        <li><a href="#" onclick="showCategory('catfood')">Cat Food</a></li>
        <li><a href="#" onclick="showCategory('cattreats')">Cat Treats</a></li>
        <li><a href="#" onclick="showCategory('cattoys')">Cat Toys</a></li>
        <li><a href="#" onclick="showCategory('catclothes')">Cat Clothes</a></li>
    </ul>
</div>
...
<div class="sale-container">
    <?php
    include 'db.php';
    $sql = "SELECT * FROM products WHERE category IN ('dogfood', 'dogtreats', 'dogtoys', 'dogclothes','catfood','cattreats','cattoys','catclothes')";
    $result = mysqli_query($conn, $sql);
    
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
    ?>
            <div class="box <?php echo $row['category']; ?>">
    <div class="icons">
